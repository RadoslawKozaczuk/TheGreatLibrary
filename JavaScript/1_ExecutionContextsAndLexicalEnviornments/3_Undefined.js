...
// not to confuse with error 'a is not defined' which means variable 'a' was not present in the memory

// never set values to undefined it is a bad practice
a = undefined;
// because it makes debugging confusing. Its better when only compilator is able to set this value 
